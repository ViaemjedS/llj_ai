import {
    ...
    SpeechT5ForTextToSpeech, // 文字转语音模型
...
// es6 新增的数据结构 HashMap 也可以先简单想象成JSON对象
...
self.onmessage = async (e) => {
    ...
    // 一个一个token 去生成
    // 以前的搜索的区别
    // prompt -> tokenizer -> LLM(函数, 向量计算, 参数十亿+级别) -> outpus 
